...
class _HospitalRegistrationScreenState extends State<HospitalRegistrationScreen> {
  ...
  void _submitForm() {
    setState(() {
      _showDocUploadError = _regCertFileName == null || _authPersonIdFileName == null;
    });

    if ((_formKey.currentState?.validate() ?? false) && !_showDocUploadError) {
      final newHospital = AyushHospital(
        applicationId: 'AYUSH-HOSP-${DateTime.now().year}-${(10000 + DateTime.now().millisecond % 90000)}',
        ...
        authorizedPersonDesignation: _authorizedDesignationController.text.trim().isEmpty
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => RegistrationSubmittedScreen(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please upload both the Hospital Registration Certificate and Authorized Person ID.'),
                  ...
                  builder: (context, constraints) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        _buildSectionTitle('1. AYUSH Facility Details', Icons.local_hospital_rounded),
                        ...
                        responsiveGrid(
                          TextFormField(
                            ...
                            decoration: _inputDecoration('Hospital Registration Number *', Icons.badge_outlined),
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                          ...
                          TextFormField(
                            ...
                            decoration: _inputDecoration('AYUSH / FIR ID *', Icons.verified_user_outlined),
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                        ...
                        responsiveGrid(
                          DropdownButtonFormField<String>(
                            ...
                            isExpanded: true,
                            decoration: _inputDecoration('Hospital Type *', Icons.domain_rounded),
                            items: _hospitalTypes
                                .map((t) => DropdownMenuItem(value: t, child: Text(t, overflow: TextOverflow.ellipsis)))
                                .toList(),
                            onChanged: (val) => setState(() => _selectedHospitalType = val),
                          ),
                          DropdownButtonFormField<String>(
                        ...
                        responsiveGrid(
                          ...
                          TextFormField(
                            ...
                            decoration: _inputDecoration('Hospital Address *', Icons.place_outlined),
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                        ...
                        _buildSectionTitle('2. Authorized Representative & Contact', Icons.admin_panel_settings_outlined),
                        const SizedBox(height: 14.0),

                        responsiveGrid(
                          TextFormField(
                            controller: _authorizedPersonController,
                            decoration: _inputDecoration('Authorized Person Name *', Icons.person_outline_rounded),
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                          ...
                          TextFormField(
                            ...
                            decoration: _inputDecoration('Designation', Icons.work_outline_rounded),
                          ),
                        ),
                        const SizedBox(height: 16.0),
                        ...
                        responsiveGrid(
                          TextFormField(
                            ...
                            decoration: _inputDecoration('Official Email *', Icons.email_outlined),
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                        ...
                        _buildSectionTitle('3. Security & Password', Icons.lock_outline_rounded),
                        const SizedBox(height: 14.0),
                        ...
                        _buildSectionTitle('4. Upload Verification Certificates', Icons.file_present_rounded),
                        const SizedBox(height: 14.0),
                        ...
                        responsiveGrid(
                          UploadCard(
                            ...
                            onTap: () {
                              setState(() {
                                _regCertFileName = 'hospital_ayush_certificate.pdf';
                                _showDocUploadError = false;
                              });
                            },
                          ),
                          UploadCard(
                            ...
                            onTap: () {
                              setState(() {
                                _authPersonIdFileName = 'authorized_person_govt_id.pdf';
                                _showDocUploadError = false;
                              });
                            },
                          ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            icon: const Icon(Icons.how_to_reg_rounded, size: 22.0),
                            label: const Text(
                              'Register Hospital',
                              style: TextStyle(
                                fontSize: 17.0,
